<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PolicyAdmins.aspx.vb" Inherits="PolicyTracker.PolicyAdmins" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="always">
        <ContentTemplate>
            ...
            <asp:GridView ID="gvDeptAdmins" runat="server" AutoGenerateColumns="False" 
                ItemType="PolicyTracker.Lib.vOrgAdmin" SelectMethod="gvDeptAdmins_GetData" DataKeyNames="OrgCode,UserId"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="OrgDesc" HeaderText="Department" SortExpression="OrgDesc" />
            ...
            <asp:DetailsView ID="dvDeptAdmin" runat="server" AutoGenerateRows="False" DataKeyNames="UserId,OrgCode"
                DataSourceID="odsDeptAdmin" Caption="Add New Department Admin" DefaultMode="Insert">
                <Fields>
                    <asp:TemplateField HeaderText="Department" SortExpression="OrgCode">
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddlDepartment" runat="server" AppendDataBoundItems="True" SelectedValue='<%# Bind("OrgCode")%>'
                                DataSourceID="odsDepartment" DataTextField="DeptDesc" DataValueField="DeptCode" Enabled="false">
                        ...
                        <InsertItemTemplate>
                            <asp:DropDownList ID="ddlDepartment" runat="server" AppendDataBoundItems="True" SelectedValue='<%# Bind("OrgCode")%>'
                                DataSourceID="odsDepartment" DataTextField="DeptDesc" DataValueField="DeptCode" Enabled="true" CssClass="select_chosen">
                                <asp:ListItem Value="">-- Select Department --</asp:ListItem>
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rfvDepartment" runat="server" ControlToValidate="ddlDepartment"
                                ErrorMessage="Department is required" Text="*" Display="Dynamic" ValidationGroup="vgDetails"></asp:RequiredFieldValidator>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:ObjectDataSource ID="odsDepartment" runat="server" OldValuesParameterFormatString="original_{0}"
                                SelectMethod="GetDepartmentsByStat" TypeName="PolicyTracker.Lib.SettingsBL">
                                <SelectParameters>
                    ...
                    <asp:TemplateField ShowHeader="False" ItemStyle-CssClass="CommandRowStyle">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lbtnNew" runat="server" CausesValidation="False" CommandName="New"
                                Text="Add New Policy Admin" CssClass="btn btn-primary btn-xs"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Fields>
            </asp:DetailsView>
            <asp:ObjectDataSource ID="odsDeptAdmin" runat="server" SelectMethod="GetUserOrg"
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="gvDeptAdmins" DefaultValue="" Name="userId" PropertyName="SelectedDataKey.Values[1]" Type="String" />
                    <asp:ControlParameter ControlID="gvDeptAdmins" DefaultValue="" Name="orgCode" PropertyName="SelectedDataKey.Values[0]" Type="String" />
                </SelectParameters>
                <UpdateParameters>
